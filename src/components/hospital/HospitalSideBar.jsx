...
const HospitalSideBar = () => {
  ...
  const menuItems = [
    { id: 1, icon: <AiOutlineAppstore size={22} />, label: "Dashboard", path: "/hospital/dashboard" },
    { id: 2, icon: <MdInventory2 size={22} />, label: "Inventory", path: "/hospital/inventory" },
    { id: 3, icon: <FiUsers size={22} />, label: "Donors", path: "/hospital/donors" },
    { id: 4, icon: <MdOutlineNotificationImportant size={22} />, label: "Alerts", path: "/hospital/alerts" },
  ];
