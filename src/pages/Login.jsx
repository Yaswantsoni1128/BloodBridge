  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-black">
      ...
      <form
        ...
        className="relative z-10 bg-white shadow-xl border border-[#f3dcdc] rounded-3xl px-8 py-6 w-full max-w-md 
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#e53935] mt-3">Login</h2>
